          ...
          <div>
            ...
            <div className="mb-4">
              <p className="text-slate-300 mb-3">
                Мы стараемся сделать сайт максимально удобным для пользователей экранных дикторов, клавиатурной навигации и мобильных устройств. Если вы столкнулись с проблемой — сообщите нам.
              </p>
              <ReportProblemDialog>
                <Button 

  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main id="main-content" role="main">
        ...
        {/* Useful Resources Navigation */}
        <section className="bg-muted py-16" aria-labelledby="useful-resources">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              <h2 id="useful-resources" className="text-3xl font-bold text-foreground mb-8">
                Полезные ресурсы
              </h2>

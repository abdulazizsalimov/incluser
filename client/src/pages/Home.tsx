          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
                {/* WCAG Guides */}
                <article className="bg-card p-8 rounded-lg shadow-sm hover:shadow-lg transition-all duration-300 hover:scale-105 border-2 border-transparent hover:border-blue-300 dark:hover:border-blue-600 focus-within:ring-2 focus-within:ring-accent">

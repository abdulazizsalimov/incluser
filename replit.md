...
```
Changelog:
- July 2, 2025. Fixed mobile image cropping issue on main page - changed mobile banner from object-cover to object-contain with gradient background to show full image without cropping while filling entire banner area
